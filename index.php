          ...
          <div class="col-lg-4 col-md-6">
            <div class="product-item">
              ...
              <div class="down-content">
                ...
                <p><?php echo $row['MaxPower'];?> &nbsp;/&nbsp; <?php echo $row['FuelType'];?> &nbsp;/&nbsp; <?php echo $row['RegYear'];?> &nbsp;/&nbsp; Brand New</p>
          ...
          <div class="col-md-12">
            <div class="owl-clients owl-carousel text-center">
              <div class="service-item">
                ...
                <div class="down-content">
                  <h4>Peter</h4>
                  <p class="n-m"><em>"Cust 1 Text"</em></p>
                </div>
              </div>
              ...
              <div class="service-item">
                ...
                <div class="down-content">
                  <h4>Parker</h4>
                  <p class="n-m"><em>"Cust 2 Text"</em></p>
                </div>
              </div>
              ...
              <div class="service-item">
                ...
                <div class="down-content">
                  <h4>Iron</h4>
                  <p class="n-m"><em>"Cust 3 Text"</em></p>
                </div>
              </div>
              ...
              <div class="service-item">
                ...
                <div class="down-content">
                  <h4></h4>
                  <p class="n-m"><em>"Cust 4 Text"</em></p>
                </div>
              </div>
              ...
              <div class="service-item">
                ...
                <div class="down-content">
                  <h4>Man</h4>
                  <p class="n-m"><em>"Cust 5 Text"</em></p>
                </div>
              </div>
            </div>
          </div>
